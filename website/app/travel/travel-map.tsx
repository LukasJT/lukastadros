...
import type {Place} from '../../content/model';
export default function TravelMap({places,emptyTitle,emptyDescription}:{places:Place[];emptyTitle:string;emptyDescription:string}){
